...
public:
  ...
  // Add comment to DRAT proof
  void add_proof_comment (const std::vector<int> &clause);

  // Add orthogonality clause to DRAT proof
  void add_proof_orthogonality_clause (const std::vector<int> &clause);

  // Add trusted clause (both to solver and DRAT proof) - like cadical-ks
  void add_trusted_clause (const std::vector<int> &clause);

  // Add trusted orthogonality clause (both to solver and DRAT proof) - like cadical-ks
  void add_trusted_orthogonality_clause (const std::vector<int> &clause);
